...
def convert_bib(input_file: str, output_file: str):
    lt = LatexNodes2Text()
...
def main():
    parser = argparse.ArgumentParser(description='Tool to convert BibTeX bibliography to a YAML file')
    parser.add_argument("-i", "--input-file", type=str, help="Input file path", default="pubs.bib")
    parser.add_argument("-o", "--output-file", type=str, help="Output file path, optional", default="pubs.yml")

    args = parser.parse_args()

    convert_bib(Path(args.input_file), Path(args.output_file))
